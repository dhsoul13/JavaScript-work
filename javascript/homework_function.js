...
function rgb(num1=0, num2=0, num3=0){
    return (num1<255 & num2<255 & num3<255) ? console.log(`rgb(${num1},${num2},${num3})`) : console.log("нет такого цвета");
}
rgb(25,33,44);
...
console.log(getNumber(5, getPowNumber, (num)=>{
    return num+1;
}))
...
function getString(str1="", str2="", str3=""){
    if(typeof(str1)=="string" & typeof(str2)=="string" & typeof(str2)=="string"){
